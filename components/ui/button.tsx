...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50 [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        gradient:
          "bg-gradient-brand text-white shadow-none hover:shadow-[0_0_24px_-4px_rgba(59,130,246,0.6)] hover:brightness-110",
        outline:
          "border border-border bg-transparent text-foreground hover:border-blue/60 hover:bg-card hover:shadow-[0_0_20px_-6px_rgba(59,130,246,0.5)]",
        ghost:
          "bg-transparent text-muted-foreground hover:text-foreground hover:bg-card/60",
        secondary:
          "bg-card text-foreground border border-border hover:border-blue/50",
      },
      size: {
